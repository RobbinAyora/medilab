    ...
    <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="relative p-6 sm:p-12 md:p-16 rounded-2xl lg:rounded-3xl bg-card border border-border/50 text-center overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-48 sm:w-64 h-48 sm:h-64 bg-primary/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute bottom-0 right-0 w-48 sm:w-64 h-48 sm:h-64 bg-accent/10 rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
